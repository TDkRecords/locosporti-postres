<script>
    let { open = $bindable(false), cliente = null, onConfirm } = $props();
...
{#if open && cliente}
    ...
    >
        ...
        >
            ...
            >
                <i class="fa-solid fa-user-slash text-xl text-red-500"></i>
            </div>
            ...
            <div class="mt-4 text-center">
                ...
                <p class="mt-2 text-sm leading-relaxed text-gray-500">
                    {cliente.nombre} pasará a estar oculto en la gestión y podrá
