...
<div class="space-y-6 p-4 sm:p-6">
        ...
        {#each metas as meta}
            <section class="rounded-3xl bg-white p-6 shadow-sm">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <span
                        class="rounded-full bg-[#CDB9FE]/20 px-3 py-1 text-xs font-semibold text-[#7c4dff]"
                    >
                ...
                <div class="mt-4">
                    ...
                    {#if pedidosCompletados >= meta.meta}
                        <p
                            class="mt-3 rounded-2xl bg-green-100 px-4 py-2 text-sm font-semibold text-green-700"
                        >
                            🎉 ¡Meta alcanzada! Comunícate con nosotros para
                            reclamar tu premio.
                        </p>
                    {:else}
                        <p class="mt-2 text-sm text-gray-400">
                            Te faltan {meta.meta - pedidosCompletados} pedidos para
                            ganar.
                        </p>
                    {/if}
                </div>
    ...
    {:else}
        <section
            class="rounded-3xl bg-white p-6 shadow-sm text-center text-gray-400"
        >
    ...
    <section class="rounded-3xl bg-white p-6 shadow-sm">
        ...
        <p class="mt-2 text-sm text-gray-500">
            Presenta este código con tus datos de perfil. Se actualiza
            automáticamente si cambias tu dirección o información personal.
        </p>
